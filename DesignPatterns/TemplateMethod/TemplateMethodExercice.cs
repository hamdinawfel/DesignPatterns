...
namespace DesignPatterns.TemplateMethod
{
    ...
    public class TemplateMethodExercice : IDisplayDemo
    {
        ...
        public void DisplayResult()
        {
            ...
            Console.WriteLine($"{game.Combat(0, 1)} is -1");
            Console.WriteLine($"{game.Combat(0, 1)} is -1");

            var c3 = new Creature(1, 1);
            var c4 = new Creature(2, 2);
            CardGame game2 = new TemporaryCardDamageGame(new[] { c3, c4 });
            Console.WriteLine($"{game2.Combat(0, 1)} is 1");
